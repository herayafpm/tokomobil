...
$routes->group('auth', ['namespace' => '\App\Controllers\Api\V1\Auth'], function ($routes) {
	$routes->post('', 'Login::index');
	$routes->post('register', 'Register::index');
	$routes->get('profile', 'Profile::index', ['filter' => 'authapi']);
	$routes->put('profile', 'Profile::ubah', ['filter' => 'authapi']);
	$routes->put('ubah_password', 'UbahPassword::index', ['filter' => 'authapi']);
